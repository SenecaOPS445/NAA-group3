...
#Group 3
#Student Names: Saira Munawar, Shawmya Sivakumar, Andrew Holder, Nishan Gharti, Juliana Giammarco 
...
def campus(file_name): 
    ...
    with open(filename, "r") as file:
        seneca_details = [] #will store campuses details
...
def generate_report(option: str, information: list):
    ...
    try:
        ...
        return print('File with that name exists already. Please try again in a minute.')
